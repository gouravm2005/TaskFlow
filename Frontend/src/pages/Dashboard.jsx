      ...
      <div className='w-[80%]  h-full flex flex-col'>
        ...
        <div className='w-full h-full bg-gray-950 overflow-y-auto text-blue-800'>
          ...
          <div className='w-full md:h-32 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 text-white text-2xl m-5 md:m-5 lg:m-12 gap-2'>
            ...
            <div className='border rounded-md flex flex-col gap-2 p-4 w-28 h-24 md:h-28 md:w-52 lg:h-32 lg:w-60 bg-gray-900'><h1 className=' text-sm md:text-lgfont-semibold text-center'>Completed</h1><h1 className='text-2xl md:text-2xl lg:text-4xl font-bold text-center'>{taskdetails.completed}</h1></div>
        ...
        <div className='w-full h-full flex md:flex-row flex-col gap-5 bg-black text-white'>
          <div className=' w-full md:w-[60%] m-4 ml-6 p-2 md:p-5 rounded-md bg-gray-900'>
          ...
          <div className=' w-full md:w-[40%] mt-2 flex flex-col p-8 rounded-md bg-gray-900'>
